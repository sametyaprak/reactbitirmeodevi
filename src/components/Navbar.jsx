      ...
      <Navbar className="p-4" bg="dark" variant="dark" expand="lg">
        ...
        <Navbar.Collapse id="basic-navbar-nav">
          <Nav className="ms-auto">
            <Link className="nav-link" to="/personel1">
              Calisanlarimiz
            </Link>
            <Link className="nav-link" to="/personel2">
              Musterilerimiz
            </Link>
            <NavDropdown title="Ufak Calismalar" id="basic-nav-dropdown">
              <NavDropdown.Item href="../ufakcalismalar/sayi.html">
                Sayi Oyunu
              </NavDropdown.Item>
              <NavDropdown.Item href="http://localhost:3000/form1">
                Form1
              </NavDropdown.Item>
              <NavDropdown.Item href="http://localhost:3000/form2">
                Form2
              </NavDropdown.Item>
            </NavDropdown>
          </Nav>
